...
export const processRequest = (
    ...
    return new Response("Forbidden, you silly goose. You're requesting from: " + new URL(request.url).hostname + " but we only accept " + new URL(origin).hostname, { status: 403 });
}